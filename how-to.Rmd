...
DR:  If your rmd/bookdowns don't build like someone else in the same repo... check  the pandoc install with `rmarkdown::find_pandoc()`. It should be in the Rstudio folder. If not, remove it & restart Rstudio. 

## Configuring and adjusting the style of this Bookdown

Video: [Tweaking and viewing the css in Chrome, adjusting it in the RP package](https://www.dropbox.com/s/l87jnsipitzdnkv/css_for_rp_bookdown_previewing_editing.mp4?dl=0)