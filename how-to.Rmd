...
DR:  If your rmd/bookdowns don't build like someone else in the same repo... check  pandoc install with `rmarkdown::find_pandoc()`. It should be in the Rstudio folder. If not, remove it & restart Rstudio. 
